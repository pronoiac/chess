...
class HumanPlayer
  ...
  def human_to_computer(string)
    ...
    raise ArgumentError.new ("Invalid input - need destination") if string.nil?
    ...
    raise ArgumentError.new ("Invalid input - couldn't parse") if computer_row.nil? || computer_col.nil?
